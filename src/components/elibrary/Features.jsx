    ...
    <div className="flex flex-col items-center about-cloud-container" style={{ backgroundColor: "#F6F6F6", width: "100vw", maxWidth: "100%" }}>
      <div className="flex flex-wrap md:flex-nowrap justify-center md:justify-between items-center mb-14">
        <div className="flex flex-col items-center">
          <LazyLoadImage effect="blur" src={Artikel} loading="lazy" alt="Gambaran dari Detail Artikel" className="about-cloud-image mt-10 rounded-xl waterfall w-full h-full" />
      ...
      <div className="w-full md:w-1/2 mx-auto px-4 md:px-8 lg:px-16">
        ...
        <p className="mt-3 font-plus-jakarta text-lg text-justify ">
      ...
      <div className="flex flex-wrap md:flex-nowrap justify-center md:justify-between items-center mb-14">
        <div className="flex flex-col items-center">
          <LazyLoadImage effect="blur" src={Admin} loading="lazy" alt="Produk & Motif Core Kampung Batik." className="about-cloud-image waterfall w-full h-full" />

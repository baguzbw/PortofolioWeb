...
import ProDesign from "../components/ProDesign";
        ...
        <div className="px-12 mb-6 mx-auto max-w-7xl">
          <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            <h1 className="mb-10 text-4xl font-bold leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight">
              <span className="block w-full py-2 font-plus-jakarta text-transparent bg-clip-text leading-12 bg-gradient-to-r from-[#8075FF] to-[#FF7171] lg:inline">Hi, Saya Bagus.</span>
            </h1>
